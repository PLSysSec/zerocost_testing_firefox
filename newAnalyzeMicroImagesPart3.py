...
def computeSummary(summaryFile, parsed1, parsed2, parsed3, parsed4, parsed5):
    with open(summaryFile, "w") as f:
        writer = csv.writer(f)
        writer.writerow(["Image", "Zerocost", "FullSave", "RegSave", "MPKFullSave", "Lucet"])
...
def main():
    ...
    computeSummary(os.path.join(inputFolderName, "all_compare.dat"), parsed1, parsed2, parsed3, parsed4, parsed5)
